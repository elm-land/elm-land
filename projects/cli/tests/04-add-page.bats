...
@test "'elm-land add page:intro /sign-in' creates a static SignIn page" {
  mkdir -p tests/tmp
  cd tests/tmp
  ...
  run elm-land add page:intro /sign-in
  expectToPass
...
@test "'elm-land add page:intro /profile/:username' creates a Profile/Username_ page" {
  mkdir -p tests/tmp
  cd tests/tmp
  ...
  run elm-land add page:intro /profile/:username
  expectToPass
