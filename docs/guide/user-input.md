...
We can create a new page that keeps track of our UI's state using the `elm-land add page:sandbox` command. This time around, we'll use `page:sandbox` instead of the `page:intro` from previous guides:
