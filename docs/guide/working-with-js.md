...
By default, for security reasons, __no environment variables__ are available. You'll need to edit your `elm-land.json` file's [app.env](../concepts/elm-land-json.md#appenv) property to allow your Elm application to access a given variable.
